...
std::vector<unsigned char>  nSigner::signMessage(const std::vector<unsigned char>& message,
...
bool nSigner::verifySignature(const std::vector<unsigned char>& signature, const std::vector<unsigned char>& message, const std::vector<unsigned char>& publicKey, NosoC::KeyType keyType)
{
